...
const ICON_LABELS: Record<string, string> = {
  ...
  Trash2: 'Trash', Apple: 'Apple', Baby: 'Baby', Backpack: 'Backpack',
  BicepsFlexed: 'Flexing', Bird: 'Bird', Bone: 'Bone', Book: 'Book',
  BrainCircuit: 'Brain', Bus: 'Bus', Calculator: 'Math', Camera: 'Camera',
  Car: 'Car', Cat: 'Cat', ChefHat: 'Chef', CircleDollarSign: 'Money',
  Clipboard: 'Clipboard', Clock: 'Clock', Cloud: 'Cloud', Coffee: 'Coffee',
  Coins: 'Coins', Cookie: 'Cookie', CookingPot: 'Cooking', Crosshair: 'Focus',
  Crown: 'Crown', Drama: 'Drama', Droplets: 'Water', Egg: 'Egg',
  Flame: 'Flame', Flower2: 'Flower', Glasses: 'Glasses',
  GraduationCap: 'School', Headphones: 'Music', Home: 'Home',
  IceCreamCone: 'Ice Cream', Laptop: 'Laptop', Layers: 'Layers',
  Lightbulb: 'Idea', List: 'List', Medal: 'Medal', Mic: 'Mic',
  Mountain: 'Hiking', Paintbrush: 'Paint', Palette: 'Art',
  PawPrint: 'Pets', Pencil: 'Pencil', PersonStanding: 'Exercise',
  Piano: 'Piano', Pizza: 'Pizza', Plane: 'Travel', Puzzle: 'Puzzle',
  Rainbow: 'Rainbow', Rocket: 'Rocket', School: 'School', Scissors: 'Craft',
  Shirt: 'Laundry', Shrub: 'Garden', Snowflake: 'Snow', Soup: 'Soup',
  Sparkles: 'Magic', Sprout: 'Plants', Swords: 'Games', Target: 'Goal',
  TestTube: 'Science', Toilet: 'Hygiene', TreePine: 'Nature',
...
const ICON_MAP: Record<string, FC<LucideProps>> = {
  ...
  Apple, Baby, Backpack, BicepsFlexed, Bird, Bone, Book, BrainCircuit,
  Bus, Calculator, Camera, Car, Cat, ChefHat, CircleDollarSign, Clipboard,
  Clock, Cloud, Coffee, Coins, Cookie, CookingPot, Crosshair, Crown,
  Drama, Droplets, Egg, Flame, Flower2, Glasses, GraduationCap,
  Headphones, Home, IceCreamCone, Laptop, Layers, Lightbulb, List,
  Medal, Mic, Mountain, Paintbrush, Palette, PawPrint,
  Pencil: PencilIcon, PersonStanding, Piano, Pizza, Plane, Puzzle, Rainbow,
  Rocket, School, Scissors, Shirt, Shrub, Snowflake, Soup,
  Sparkles, Sprout, Swords, Target, TestTube, Toilet, TreePine,
  Trophy, Tv, Umbrella, Volleyball, Waves, Wind, Wrench,
};
...
const EDIT_ICONS: { key: string; Icon: FC<LucideProps> }[] = [
  ...
  { key: 'BrainCircuit', Icon: BrainCircuit },
  { key: 'Lightbulb', Icon: Lightbulb },
  { key: 'TestTube', Icon: TestTube },
  { key: 'Dumbbell', Icon: Dumbbell },
  { key: 'Bike', Icon: Bike },
  { key: 'BicepsFlexed', Icon: BicepsFlexed },
  { key: 'PersonStanding', Icon: PersonStanding },
  ...
  { key: 'CircleDollarSign', Icon: CircleDollarSign },
  { key: 'Zap', Icon: Zap },
        ...
        <Pressable style={styles.sheetOverlay} onPress={() => setEditSheet(null)}>
          <SwipeDismissSheet onDismiss={() => setEditSheet(null)} style={[styles.awardSheet, { alignItems: 'stretch', paddingBottom: 48 }]}>
            ...
            <View style={{ alignItems: 'center', marginBottom: 20 }}>
              ...
              />
              <Text style={[styles.sheetTitle, { textAlign: 'center', fontSize: 20, marginTop: 10, marginBottom: 0 }]}>Edit Task</Text>
            </View>
